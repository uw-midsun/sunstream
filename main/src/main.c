...
void app_main(void)
{
    ...
    ESP_LOGI("main", "Publish task created, size of datagram: %d, size of datagram header: %d, size of can message: %d", sizeof(sunstream_datagram_t), 
    sizeof(sunstream_datagram_header_t), sizeof(sunstream_can_msg_t));
